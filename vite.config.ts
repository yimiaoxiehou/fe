...
export default defineConfig({
  ...
  server: {
    proxy: {
      '/api/n9e-plus': {
        target: 'http://192.168.44.185:17000/',
        changeOrigin: true,
      },
      '/api/n9e/proxy': {
        target: 'http://192.168.44.185:17000/',
      ...
      '/api/fc-brain': {
        target: 'http://192.168.44.185:28000/',
        changeOrigin: true,
      },
    },
  },
    ...
    preprocessorOptions: {
      less: {
        ...
        modifyVars: {
          ...
          'text-color': '#262626',
          'table-row-hover-bg': '#c0cfe8',
          'table-header-bg': '#f0f0f0',
          'select-selection-item-bg': '#c0cfe8',
          'select-selection-item-border-color': '#2e60b1',
          'menu-item-color': '#8C8C8C',
          'menu-inline-submenu-bg': '#f0f0f0',
          'menu-bg': '#f0f0f0',
          'checkbox-check-bg': '#fff',
          'checkbox-check-color': '#2e60b1',
